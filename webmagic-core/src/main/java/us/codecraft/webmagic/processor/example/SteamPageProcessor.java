...
public class SteamPageProcessor implements PageProcessor {
    ...
    public void process(Page page) {
            ...
            //将下一页的链接加入待抓取队列
            page.addTargetRequests(page.getHtml().xpath("//div[@class='search_pagination']").links().all());
    }
    ...
    public static void main(String[] args) {
        Spider.create(new SteamPageProcessor()).addUrl("https://store.steampowered.com/search/?specials=1&os=win").run();
    }
}
